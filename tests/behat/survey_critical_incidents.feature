...
Feature: A teacher navigates to response reports of students
  If coursesat activity is configured for critical students
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | coursesat   | Test coursesat name | C1     | coursesat1   | 5        |

  Scenario: Only questions and participants page should be available under response reports as teacher
    Given I am on the "Test coursesat name" "coursesat activity" page logged in as student1
    ...
    And I am on the "Test coursesat name" "coursesat activity" page logged in as student2
    ...
    And I press "Submit"
    And I press "Continue"
    When I am on the "Test coursesat name" "coursesat activity" page logged in as teacher1
