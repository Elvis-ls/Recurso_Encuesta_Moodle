...
/**
 * The mod_coursesat report downloaded event.
 *
...
/**
 * The mod_coursesat report downloaded event class.
 *
...
class report_downloaded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportdownloaded', 'mod_coursesat');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' downloaded the report for the coursesat with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url("/mod/coursesat/download.php", $params);
    }
